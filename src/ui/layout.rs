...
/// Synth section when collapsed (border + step row + border) — legacy constant.
...
// ── Legacy ComputedLayout (used by current render + mouse code) ──────────────
...
/// (Legacy signature — will be replaced by compute_dual_layout in Tasks 8/10.)
